        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserName = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483646, nullable: false),
                    Password = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483646, nullable: false),
                    Role = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483646, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483646, nullable: false),
                    Phone = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483646, nullable: false),
                    Address = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483646, nullable: false),
                    Email = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483646, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameLand = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483646, nullable: false),
                    Title = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483646, nullable: false),
                    Policy = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483646, nullable: false),
                    Location = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483646, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Note = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483646, nullable: false),
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483646, nullable: false),
                    LandId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PitchImage", x => x.ImageId);
                    table.ForeignKey(
